...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            # self.epsilon = 1.0/(self.count**0.5)
            # self.epsilon = 1.0/(self.count**-2)
            self.epsilon = abs(math.cos(self.alpha*self.count))
            # self.epsilon = abs(self.epsilon**-(self.alpha*self.count))
            # self.epsilon = (0.99**self.count)**2
    ...
    def choose_action(self, state):
        ...
        if not self.learning:
            ...
            if 0.01 > self.epsilon > random.random():
                action = random.choice(self.valid_actions)
            else:
                valid_actions = []
